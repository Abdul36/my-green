  ...
  return (
    <div>
      <section className="container-fluid ">
        <div className="row ">
          <div className="col-md bg-dark text-white text-center p-4 ">
            <button
            ...
            <div className="d-flex ntr">
              ...
              <div>
                <p className="timing">
                  mon-thu: 11.00 – 23.00 <br></br> sat: 12.00 – 23.00 <br></br>{" "}
                  sun: 12.00 – 21.00
                </p>
              </div>
            </div>
            <div className="d-flex ntr pt-4">
              ...
              <div>
                <p className="timing">
                  60 East 65th Street <br></br> New York City <br></br> NY 10065
                </p>
              </div>
            </div>
            <div className="social pt-4">
              <img src={facebook} alt="facebook" className="img-fluid" />
              <img src={linkedin} alt="linkedin" className="img-fluid ms-5" />
              <img src={pintrest} alt="pintrest" className="img-fluid ms-5" />
              <img src={twitter} alt="twitter" className="img-fluid ms-5" />
            </div>
          </div>
